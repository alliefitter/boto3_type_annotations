...
class Client(BaseClient):
    ...
    def complete_multipart_upload(self, Bucket: str, Key: str, MultipartUpload: Dict = None, UploadId: str, RequestPayer: str = None) -> Dict:
        """
    ...
    def copy_object(self, ACL: str = None, Bucket: str, CacheControl: str = None, ContentDisposition: str = None, ContentEncoding: str = None, ContentLanguage: str = None, ContentType: str = None, CopySource: Union[str, Dict], CopySourceIfMatch: str = None, CopySourceIfModifiedSince: datetime = None, CopySourceIfNoneMatch: str = None, CopySourceIfUnmodifiedSince: datetime = None, Expires: datetime = None, GrantFullControl: str = None, GrantRead: str = None, GrantReadACP: str = None, GrantWriteACP: str = None, Key: str, Metadata: Dict = None, MetadataDirective: str = None, TaggingDirective: str = None, ServerSideEncryption: str = None, StorageClass: str = None, WebsiteRedirectLocation: str = None, SSECustomerAlgorithm: str = None, SSECustomerKey: str = None, SSECustomerKeyMD5: str = None, SSEKMSKeyId: str = None, CopySourceSSECustomerAlgorithm: str = None, CopySourceSSECustomerKey: str = None, CopySourceSSECustomerKeyMD5: str = None, RequestPayer: str = None, Tagging: str = None) -> Dict:
        """
    ...
    def create_bucket(self, ACL: str = None, Bucket: str, CreateBucketConfiguration: Dict = None, GrantFullControl: str = None, GrantRead: str = None, GrantReadACP: str = None, GrantWrite: str = None, GrantWriteACP: str = None) -> Dict:
        """
    ...
    def create_multipart_upload(self, ACL: str = None, Bucket: str, CacheControl: str = None, ContentDisposition: str = None, ContentEncoding: str = None, ContentLanguage: str = None, ContentType: str = None, Expires: datetime = None, GrantFullControl: str = None, GrantRead: str = None, GrantReadACP: str = None, GrantWriteACP: str = None, Key: str, Metadata: Dict = None, ServerSideEncryption: str = None, StorageClass: str = None, WebsiteRedirectLocation: str = None, SSECustomerAlgorithm: str = None, SSECustomerKey: str = None, SSECustomerKeyMD5: str = None, SSEKMSKeyId: str = None, RequestPayer: str = None, Tagging: str = None) -> Dict:
        """
    ...
    def head_object(self, Bucket: str, IfMatch: str = None, IfModifiedSince: datetime = None, IfNoneMatch: str = None, IfUnmodifiedSince: datetime = None, Key: str, Range: str = None, VersionId: str = None, SSECustomerAlgorithm: str = None, SSECustomerKey: str = None, SSECustomerKeyMD5: str = None, RequestPayer: str = None, PartNumber: int = None) -> Dict:
        """
    ...
    def list_parts(self, Bucket: str, Key: str, MaxParts: int = None, PartNumberMarker: int = None, UploadId: str, RequestPayer: str = None) -> Dict:
        """
    ...
    def put_bucket_acl(self, ACL: str = None, AccessControlPolicy: Dict = None, Bucket: str, GrantFullControl: str = None, GrantRead: str = None, GrantReadACP: str = None, GrantWrite: str = None, GrantWriteACP: str = None) -> NoReturn:
        """
    ...
    def put_bucket_encryption(self, Bucket: str, ContentMD5: str = None, ServerSideEncryptionConfiguration: Dict) -> NoReturn:
        """
...
:returns: None
    ...
    def put_bucket_policy(self, Bucket: str, ConfirmRemoveSelfBucketAccess: bool = None, Policy: str) -> NoReturn:
        """
    ...
    def put_bucket_versioning(self, Bucket: str, MFA: str = None, VersioningConfiguration: Dict) -> NoReturn:
        """
    ...
    def put_object(self, ACL: str = None, Body: Union[bytes, IO] = None, Bucket: str, CacheControl: str = None, ContentDisposition: str = None, ContentEncoding: str = None, ContentLanguage: str = None, ContentLength: int = None, ContentMD5: str = None, ContentType: str = None, Expires: datetime = None, GrantFullControl: str = None, GrantRead: str = None, GrantReadACP: str = None, GrantWriteACP: str = None, Key: str, Metadata: Dict = None, ServerSideEncryption: str = None, StorageClass: str = None, WebsiteRedirectLocation: str = None, SSECustomerAlgorithm: str = None, SSECustomerKey: str = None, SSECustomerKeyMD5: str = None, SSEKMSKeyId: str = None, RequestPayer: str = None, Tagging: str = None) -> Dict:
        """
    ...
    def put_object_acl(self, ACL: str = None, AccessControlPolicy: Dict = None, Bucket: str, GrantFullControl: str = None, GrantRead: str = None, GrantReadACP: str = None, GrantWrite: str = None, GrantWriteACP: str = None, Key: str, RequestPayer: str = None, VersionId: str = None) -> Dict:
        """
    ...
    def put_object_tagging(self, Bucket: str, Key: str, VersionId: str = None, ContentMD5: str = None, Tagging: Dict) -> Dict:
        """
    ...
    def select_object_content(self, Bucket: str, Key: str, SSECustomerAlgorithm: str = None, SSECustomerKey: str = None, SSECustomerKeyMD5: str = None, Expression: str, ExpressionType: str, RequestProgress: Dict = None, InputSerialization: Dict, OutputSerialization: Dict) -> Dict:
        """
    ...
    def upload_part(self, Body: Union[bytes, IO] = None, Bucket: str, ContentLength: int = None, ContentMD5: str = None, Key: str, PartNumber: int, UploadId: str, SSECustomerAlgorithm: str = None, SSECustomerKey: str = None, SSECustomerKeyMD5: str = None, RequestPayer: str = None) -> Dict:
        """
    ...
    def upload_part_copy(self, Bucket: str, CopySource: Union[str, Dict], CopySourceIfMatch: str = None, CopySourceIfModifiedSince: datetime = None, CopySourceIfNoneMatch: str = None, CopySourceIfUnmodifiedSince: datetime = None, CopySourceRange: str = None, Key: str, PartNumber: int, UploadId: str, SSECustomerAlgorithm: str = None, SSECustomerKey: str = None, SSECustomerKeyMD5: str = None, CopySourceSSECustomerAlgorithm: str = None, CopySourceSSECustomerKey: str = None, CopySourceSSECustomerKeyMD5: str = None, RequestPayer: str = None) -> Dict:
        """
