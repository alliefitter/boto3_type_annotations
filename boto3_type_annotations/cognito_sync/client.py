...
class Client(BaseClient):
    ...
    def update_records(self, IdentityPoolId: str, IdentityId: str, DatasetName: str, DeviceId: str = None, RecordPatches: List = None, SyncSessionToken: str, ClientContext: str = None) -> Dict:
        """
