...
class Client(BaseClient):
    ...
    def create_user(self, BrokerId: str, ConsoleAccess: bool = None, Groups: List = None, Password: str = None, Username: str) -> Dict:
        """
    ...
    def update_broker(self, AutoMinorVersionUpgrade: bool = None, BrokerId: str, Configuration: Dict = None, EngineVersion: str = None, Logs: Dict = None) -> Dict:
        """
    ...
    def update_user(self, BrokerId: str, ConsoleAccess: bool = None, Groups: List = None, Password: str = None, Username: str) -> Dict:
        """
