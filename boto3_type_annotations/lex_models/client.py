...
class Client(BaseClient):
    ...
    def put_bot(self, name: str, description: str = None, intents: List = None, clarificationPrompt: Dict = None, abortStatement: Dict = None, idleSessionTTLInSeconds: int = None, voiceId: str = None, checksum: str = None, processBehavior: str = None, locale: str, childDirected: bool, createVersion: bool = None) -> Dict:
        """
    ...
    def put_bot_alias(self, name: str, description: str = None, botVersion: str, botName: str, checksum: str = None) -> Dict:
        """
