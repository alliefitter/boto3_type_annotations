...
class Client(BaseClient):
    ...
    def create_private_dns_namespace(self, Name: str, CreatorRequestId: str = None, Description: str = None, Vpc: str) -> Dict:
        """
    ...
    def create_service(self, Name: str, CreatorRequestId: str = None, Description: str = None, DnsConfig: Dict, HealthCheckConfig: Dict = None, HealthCheckCustomConfig: Dict = None) -> Dict:
        """
    ...
    def register_instance(self, ServiceId: str, InstanceId: str, CreatorRequestId: str = None, Attributes: Dict) -> Dict:
        """
