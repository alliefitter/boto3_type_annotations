...
class Client(BaseClient):
    ...
    def create_instances(self, instanceNames: List, availabilityZone: str, customImageName: str = None, blueprintId: str, bundleId: str, userData: str = None, keyPairName: str = None) -> Dict:
        """
    ...
    def create_instances_from_snapshot(self, instanceNames: List, attachedDiskMapping: Dict = None, availabilityZone: str, instanceSnapshotName: str, bundleId: str, userData: str = None, keyPairName: str = None) -> Dict:
        """
    ...
    def create_relational_database(self, relationalDatabaseName: str, availabilityZone: str = None, relationalDatabaseBlueprintId: str, relationalDatabaseBundleId: str, masterDatabaseName: str, masterUsername: str, masterUserPassword: str = None, preferredBackupWindow: str = None, preferredMaintenanceWindow: str = None, publiclyAccessible: bool = None) -> Dict:
        """
