...
class Client(BaseClient):
    ...
    def create_environment_ec2(self, name: str, description: str = None, clientRequestToken: str = None, instanceType: str, subnetId: str = None, automaticStopTimeMinutes: int = None, ownerArn: str = None) -> Dict:
        """
