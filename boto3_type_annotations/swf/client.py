...
class Client(BaseClient):
    ...
    def list_activity_types(self, domain: str, name: str = None, registrationStatus: str, nextPageToken: str = None, maximumPageSize: int = None, reverseOrder: bool = None) -> Dict:
        """
    ...
    def list_domains(self, nextPageToken: str = None, registrationStatus: str, maximumPageSize: int = None, reverseOrder: bool = None) -> Dict:
        """
    ...
    def list_workflow_types(self, domain: str, name: str = None, registrationStatus: str, nextPageToken: str = None, maximumPageSize: int = None, reverseOrder: bool = None) -> Dict:
        """
    ...
    def register_domain(self, name: str, description: str = None, workflowExecutionRetentionPeriodInDays: str) -> NoReturn:
        """
    ...
    def signal_workflow_execution(self, domain: str, workflowId: str, runId: str = None, signalName: str, input: str = None) -> NoReturn:
        """
