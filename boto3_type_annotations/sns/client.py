...
class Client(BaseClient):
    ...
    def publish(self, TopicArn: str = None, TargetArn: str = None, PhoneNumber: str = None, Message: str, Subject: str = None, MessageStructure: str = None, MessageAttributes: Dict = None) -> Dict:
        """
