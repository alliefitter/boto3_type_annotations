...
class PlatformEndpoint(base.ServiceResource):
    ...
    def publish(self, TopicArn: str = None, PhoneNumber: str = None, Message: str, Subject: str = None, MessageStructure: str = None, MessageAttributes: Dict = None) -> Dict:
        """
...
class Topic(base.ServiceResource):
    ...
    def publish(self, TargetArn: str = None, PhoneNumber: str = None, Message: str, Subject: str = None, MessageStructure: str = None, MessageAttributes: Dict = None) -> Dict:
        """
        Sends a message to an Amazon SNS topic or sends a text message (SMS message) directly to a phone number. 
