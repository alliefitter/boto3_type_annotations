...
class Client(BaseClient):
    ...
    def create_stream(self, DeviceName: str = None, StreamName: str, MediaType: str = None, KmsKeyId: str = None, DataRetentionInHours: int = None) -> Dict:
        """
    ...
    def get_data_endpoint(self, StreamName: str = None, StreamARN: str = None, APIName: str) -> Dict:
        """
    ...
    def tag_stream(self, StreamARN: str = None, StreamName: str = None, Tags: Dict) -> Dict:
        """
    ...
    def untag_stream(self, StreamARN: str = None, StreamName: str = None, TagKeyList: List) -> Dict:
        """
    ...
    def update_data_retention(self, StreamName: str = None, StreamARN: str = None, CurrentVersion: str, Operation: str, DataRetentionChangeInHours: int) -> Dict:
        """
    ...
    def update_stream(self, StreamName: str = None, StreamARN: str = None, CurrentVersion: str, DeviceName: str = None, MediaType: str = None) -> Dict:
        """
