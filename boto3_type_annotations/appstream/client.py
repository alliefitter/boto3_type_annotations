...
class Client(BaseClient):
    ...
    def create_fleet(self, Name: str, ImageName: str = None, ImageArn: str = None, InstanceType: str, FleetType: str = None, ComputeCapacity: Dict, VpcConfig: Dict = None, MaxUserDurationInSeconds: int = None, DisconnectTimeoutInSeconds: int = None, Description: str = None, DisplayName: str = None, EnableDefaultInternetAccess: bool = None, DomainJoinInfo: Dict = None) -> Dict:
        """
    ...
    def create_image_builder(self, Name: str, ImageName: str = None, ImageArn: str = None, InstanceType: str, Description: str = None, DisplayName: str = None, VpcConfig: Dict = None, EnableDefaultInternetAccess: bool = None, DomainJoinInfo: Dict = None, AppstreamAgentVersion: str = None) -> Dict:
        """
    ...
    def create_user(self, UserName: str, MessageAction: str = None, FirstName: str = None, LastName: str = None, AuthenticationType: str) -> Dict:
        """
    ...
    def update_stack(self, DisplayName: str = None, Description: str = None, Name: str, StorageConnectors: List = None, DeleteStorageConnectors: bool = None, RedirectURL: str = None, FeedbackURL: str = None, AttributesToDelete: List = None, UserSettings: List = None, ApplicationSettings: Dict = None) -> Dict:
        """
