...
class Client(BaseClient):
    ...
    def delete_stack_instances(self, StackSetName: str, Accounts: List, Regions: List, OperationPreferences: Dict = None, RetainStacks: bool, OperationId: str = None) -> Dict:
        """
