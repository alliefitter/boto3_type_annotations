...
class Client(BaseClient):
    ...
    def create_project(self, name: str, description: str = None, source: Dict, secondarySources: List = None, artifacts: Dict, secondaryArtifacts: List = None, cache: Dict = None, environment: Dict, serviceRole: str, timeoutInMinutes: int = None, encryptionKey: str = None, tags: List = None, vpcConfig: Dict = None, badgeEnabled: bool = None, logsConfig: Dict = None) -> Dict:
        """
