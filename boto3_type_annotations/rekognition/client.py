...
class Client(BaseClient):
    ...
    def start_face_search(self, Video: Dict, ClientRequestToken: str = None, FaceMatchThreshold: float = None, CollectionId: str, NotificationChannel: Dict = None, JobTag: str = None) -> Dict:
        """
