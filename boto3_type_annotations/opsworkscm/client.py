...
class Client(BaseClient):
    ...
    def create_server(self, AssociatePublicIpAddress: bool = None, DisableAutomatedBackup: bool = None, Engine: str = None, EngineModel: str = None, EngineVersion: str = None, EngineAttributes: List = None, BackupRetentionCount: int = None, ServerName: str, InstanceProfileArn: str, InstanceType: str, KeyPair: str = None, PreferredMaintenanceWindow: str = None, PreferredBackupWindow: str = None, SecurityGroupIds: List = None, ServiceRoleArn: str, SubnetIds: List = None, BackupId: str = None) -> Dict:
        """
    ...
    def update_server(self, DisableAutomatedBackup: bool = None, BackupRetentionCount: int = None, ServerName: str, PreferredMaintenanceWindow: str = None, PreferredBackupWindow: str = None) -> Dict:
        """
