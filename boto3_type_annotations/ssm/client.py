...
class Client(BaseClient):
    ...
    def create_activation(self, Description: str = None, DefaultInstanceName: str = None, IamRole: str, RegistrationLimit: int = None, ExpirationDate: datetime = None) -> Dict:
        """
    ...
    def create_maintenance_window(self, Name: str, Description: str = None, StartDate: str = None, EndDate: str = None, Schedule: str, ScheduleTimezone: str = None, Duration: int, Cutoff: int, AllowUnassociatedTargets: bool, ClientToken: str = None) -> Dict:
        """
    ...
    def label_parameter_version(self, Name: str, ParameterVersion: int = None, Labels: List) -> Dict:
        """
    ...
    def put_parameter(self, Name: str, Description: str = None, Value: str, Type: str, KeyId: str = None, Overwrite: bool = None, AllowedPattern: str = None) -> Dict:
        """
    ...
    def register_task_with_maintenance_window(self, WindowId: str, Targets: List, TaskArn: str, ServiceRoleArn: str = None, TaskType: str, TaskParameters: Dict = None, TaskInvocationParameters: Dict = None, Priority: int = None, MaxConcurrency: str, MaxErrors: str, LoggingInfo: Dict = None, Name: str = None, Description: str = None, ClientToken: str = None) -> Dict:
        """
