...
class Client(BaseClient):
    ...
    def create_replication_instance(self, ReplicationInstanceIdentifier: str, AllocatedStorage: int = None, ReplicationInstanceClass: str, VpcSecurityGroupIds: List = None, AvailabilityZone: str = None, ReplicationSubnetGroupIdentifier: str = None, PreferredMaintenanceWindow: str = None, MultiAZ: bool = None, EngineVersion: str = None, AutoMinorVersionUpgrade: bool = None, Tags: List = None, KmsKeyId: str = None, PubliclyAccessible: bool = None) -> Dict:
        """
    ...
    def modify_replication_subnet_group(self, ReplicationSubnetGroupIdentifier: str, ReplicationSubnetGroupDescription: str = None, SubnetIds: List) -> Dict:
        """
