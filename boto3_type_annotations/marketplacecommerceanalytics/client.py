...
class Client(BaseClient):
    ...
    def generate_data_set(self, dataSetType: str, dataSetPublicationDate: datetime, roleNameArn: str, destinationS3BucketName: str, destinationS3Prefix: str = None, snsTopicArn: str, customerDefinedValues: Dict = None) -> Dict:
        """
    ...
    def start_support_data_export(self, dataSetType: str, fromDate: datetime, roleNameArn: str, destinationS3BucketName: str, destinationS3Prefix: str = None, snsTopicArn: str, customerDefinedValues: Dict = None) -> Dict:
        """
