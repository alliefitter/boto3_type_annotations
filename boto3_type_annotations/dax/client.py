...
class Client(BaseClient):
    ...
    def create_cluster(self, ClusterName: str, NodeType: str, Description: str = None, ReplicationFactor: int, AvailabilityZones: List = None, SubnetGroupName: str = None, SecurityGroupIds: List = None, PreferredMaintenanceWindow: str = None, NotificationTopicArn: str = None, IamRoleArn: str, ParameterGroupName: str = None, Tags: List = None, SSESpecification: Dict = None) -> Dict:
        """
    ...
    def create_subnet_group(self, SubnetGroupName: str, Description: str = None, SubnetIds: List) -> Dict:
        """
