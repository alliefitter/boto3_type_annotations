...
class Client(BaseClient):
    ...
    def get_id(self, AccountId: str = None, IdentityPoolId: str, Logins: Dict = None) -> Dict:
        """
    ...
    def get_open_id_token_for_developer_identity(self, IdentityPoolId: str, IdentityId: str = None, Logins: Dict, TokenDuration: int = None) -> Dict:
        """
