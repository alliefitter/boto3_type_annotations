...
class Client(BaseClient):
    ...
    def get_dimension_values(self, SearchString: str = None, TimePeriod: Dict, Dimension: str, Context: str = None, NextPageToken: str = None) -> Dict:
        """
    ...
    def get_reservation_purchase_recommendation(self, AccountId: str = None, Service: str, AccountScope: str = None, LookbackPeriodInDays: str = None, TermInYears: str = None, PaymentOption: str = None, ServiceSpecification: Dict = None, PageSize: int = None, NextPageToken: str = None) -> Dict:
        """
    ...
    def get_tags(self, SearchString: str = None, TimePeriod: Dict, TagKey: str = None, NextPageToken: str = None) -> Dict:
        """
