...
class Client(BaseClient):
    ...
    def create_cluster(self, JobType: str, Resources: Dict, Description: str = None, AddressId: str, KmsKeyARN: str = None, RoleARN: str, SnowballType: str = None, ShippingOption: str, Notification: Dict = None, ForwardingAddressId: str = None) -> Dict:
        """
