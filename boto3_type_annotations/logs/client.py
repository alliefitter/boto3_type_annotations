...
class Client(BaseClient):
    ...
    def create_export_task(self, taskName: str = None, logGroupName: str, logStreamNamePrefix: str = None, fromTime: int, to: int, destination: str, destinationPrefix: str = None) -> Dict:
        """
