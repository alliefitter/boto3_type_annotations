...
class Client(BaseClient):
    ...
    def create_deployment_group(self, applicationName: str, deploymentGroupName: str, deploymentConfigName: str = None, ec2TagFilters: List = None, onPremisesInstanceTagFilters: List = None, autoScalingGroups: List = None, serviceRoleArn: str, triggerConfigurations: List = None, alarmConfiguration: Dict = None, autoRollbackConfiguration: Dict = None, deploymentStyle: Dict = None, blueGreenDeploymentConfiguration: Dict = None, loadBalancerInfo: Dict = None, ec2TagSet: Dict = None, onPremisesTagSet: Dict = None) -> Dict:
        """
    ...
    def register_application_revision(self, applicationName: str, description: str = None, revision: Dict) -> NoReturn:
        """
