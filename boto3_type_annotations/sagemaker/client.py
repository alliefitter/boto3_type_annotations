...
class Client(BaseClient):
    ...
    def create_notebook_instance(self, NotebookInstanceName: str, InstanceType: str, SubnetId: str = None, SecurityGroupIds: List = None, RoleArn: str, KmsKeyId: str = None, Tags: List = None, LifecycleConfigName: str = None, DirectInternetAccess: str = None, VolumeSizeInGB: int = None) -> Dict:
        """
    ...
    def create_training_job(self, TrainingJobName: str, HyperParameters: Dict = None, AlgorithmSpecification: Dict, RoleArn: str, InputDataConfig: List = None, OutputDataConfig: Dict, ResourceConfig: Dict, VpcConfig: Dict = None, StoppingCondition: Dict, Tags: List = None) -> Dict:
        """
    ...
    def create_transform_job(self, TransformJobName: str, ModelName: str, MaxConcurrentTransforms: int = None, MaxPayloadInMB: int = None, BatchStrategy: str = None, Environment: Dict = None, TransformInput: Dict, TransformOutput: Dict, TransformResources: Dict, Tags: List = None) -> Dict:
        """
