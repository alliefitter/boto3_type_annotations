...
class ServiceResource(base.ServiceResource):
    ...
    def create_group(self, Path: str = None, GroupName: str) -> List['Group']:
        """
        Creates a new group.
    ...
    def create_policy(self, PolicyName: str, Path: str = None, PolicyDocument: str, Description: str = None) -> 'Policy':
        """
    ...
    def create_role(self, Path: str = None, RoleName: str, AssumeRolePolicyDocument: str, Description: str = None, MaxSessionDuration: int = None, PermissionsBoundary: str = None) -> 'Role':
        """
    ...
    def create_server_certificate(self, Path: str = None, ServerCertificateName: str, CertificateBody: str, PrivateKey: str, CertificateChain: str = None) -> 'ServerCertificate':
        """
    ...
    def create_signing_certificate(self, UserName: str = None, CertificateBody: str) -> 'SigningCertificate':
        """
    ...
    def create_user(self, Path: str = None, UserName: str, PermissionsBoundary: str = None) -> 'User':
        """
    ...
    def create_virtual_mfa_device(self, Path: str = None, VirtualMFADeviceName: str) -> 'VirtualMfaDevice':
        """
