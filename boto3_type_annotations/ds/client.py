...
class Client(BaseClient):
    ...
    def connect_directory(self, Name: str, ShortName: str = None, Password: str, Description: str = None, Size: str, ConnectSettings: Dict) -> Dict:
        """
    ...
    def create_directory(self, Name: str, ShortName: str = None, Password: str, Description: str = None, Size: str, VpcSettings: Dict = None) -> Dict:
        """
    ...
    def create_microsoft_ad(self, Name: str, ShortName: str = None, Password: str, Description: str = None, VpcSettings: Dict, Edition: str = None) -> Dict:
        """
    ...
    def share_directory(self, DirectoryId: str, ShareNotes: str = None, ShareTarget: Dict, ShareMethod: str) -> Dict:
        """
