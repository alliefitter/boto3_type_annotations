...
class Client(BaseClient):
    ...
    def create_app(self, StackId: str, Shortname: str = None, Name: str, Description: str = None, DataSources: List = None, Type: str, AppSource: Dict = None, Domains: List = None, EnableSsl: bool = None, SslConfiguration: Dict = None, Attributes: Dict = None, Environment: List = None) -> Dict:
        """
    ...
    def create_deployment(self, StackId: str, AppId: str = None, InstanceIds: List = None, LayerIds: List = None, Command: Dict, Comment: str = None, CustomJson: str = None) -> Dict:
        """
    ...
    def register_volume(self, Ec2VolumeId: str = None, StackId: str) -> Dict:
        """
