...
class Client(BaseClient):
    ...
    def create_grant(self, KeyId: str, GranteePrincipal: str, RetiringPrincipal: str = None, Operations: List, Constraints: Dict = None, GrantTokens: List = None, Name: str = None) -> Dict:
        """
    ...
    def list_grants(self, Limit: int = None, Marker: str = None, KeyId: str) -> Dict:
        """
    ...
    def list_retirable_grants(self, Limit: int = None, Marker: str = None, RetiringPrincipal: str) -> Dict:
        """
    ...
    def re_encrypt(self, CiphertextBlob: bytes, SourceEncryptionContext: Dict = None, DestinationKeyId: str, DestinationEncryptionContext: Dict = None, GrantTokens: List = None) -> Dict:
        """
