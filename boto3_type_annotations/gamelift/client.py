...
class Client(BaseClient):
    ...
    def create_alias(self, Name: str, Description: str = None, RoutingStrategy: Dict) -> Dict:
        """
    ...
    def create_fleet(self, Name: str, Description: str = None, BuildId: str, ServerLaunchPath: str = None, ServerLaunchParameters: str = None, LogPaths: List = None, EC2InstanceType: str, EC2InboundPermissions: List = None, NewGameSessionProtectionPolicy: str = None, RuntimeConfiguration: Dict = None, ResourceCreationLimitPolicy: Dict = None, MetricGroups: List = None, PeerVpcAwsAccountId: str = None, PeerVpcId: str = None, FleetType: str = None) -> Dict:
        """
    ...
    def create_game_session(self, FleetId: str = None, AliasId: str = None, MaximumPlayerSessionCount: int, Name: str = None, GameProperties: List = None, CreatorId: str = None, GameSessionId: str = None, IdempotencyToken: str = None, GameSessionData: str = None) -> Dict:
        """
    ...
    def create_matchmaking_configuration(self, Name: str, Description: str = None, GameSessionQueueArns: List, RequestTimeoutSeconds: int, AcceptanceTimeoutSeconds: int = None, AcceptanceRequired: bool, RuleSetName: str, NotificationTarget: str = None, AdditionalPlayerCount: int = None, CustomEventData: str = None, GameProperties: List = None, GameSessionData: str = None) -> Dict:
        """
    ...
    def put_scaling_policy(self, Name: str, FleetId: str, ScalingAdjustment: int = None, ScalingAdjustmentType: str = None, Threshold: float = None, ComparisonOperator: str = None, EvaluationPeriods: int = None, MetricName: str, PolicyType: str = None, TargetConfiguration: Dict = None) -> Dict:
        """
    ...
    def start_game_session_placement(self, PlacementId: str, GameSessionQueueName: str, GameProperties: List = None, MaximumPlayerSessionCount: int, GameSessionName: str = None, PlayerLatencies: List = None, DesiredPlayerSessions: List = None, GameSessionData: str = None) -> Dict:
        """
    ...
    def start_match_backfill(self, TicketId: str = None, ConfigurationName: str, GameSessionArn: str, Players: List) -> Dict:
        """
    ...
    def start_matchmaking(self, TicketId: str = None, ConfigurationName: str, Players: List) -> Dict:
        """
