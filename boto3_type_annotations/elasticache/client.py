...
class Client(BaseClient):
    def add_tags_to_resource(self, ResourceName: str, Tags: List) -> Dict:
        ...
        When you apply tags to your ElastiCache resources, AWS generates a cost allocation report as a comma-separated value (CSV) file with your usage and costs aggregated by your tags. You can apply tags that represent business categories (such as cost centers, application names, or owners) to organize your costs across multiple services. For more information, see `Using Cost Allocation Tags in Amazon ElastiCache <http://docs.aws.amazon.com/AmazonElastiCache/latest/red-ug/Tagging.html>`__ in the *ElastiCache User Guide* .
    ...
    def create_cache_parameter_group(self, CacheParameterGroupName: str, CacheParameterGroupFamily: str, Description: str) -> Dict:
        ...
        * `Parameters and Parameter Groups <http://docs.aws.amazon.com/AmazonElastiCache/latest/red-ug/ParameterGroups.html>`__ in the ElastiCache User Guide. 
    ...
    def create_snapshot(self, ReplicationGroupId: str = None, CacheClusterId: str = None, SnapshotName: str) -> Dict:
        """
    ...
    def decrease_replica_count(self, ReplicationGroupId: str, NewReplicaCount: int = None, ReplicaConfiguration: List = None, ReplicasToRemove: List = None, ApplyImmediately: bool) -> Dict:
        """
    ...
    def increase_replica_count(self, ReplicationGroupId: str, NewReplicaCount: int = None, ReplicaConfiguration: List = None, ApplyImmediately: bool) -> Dict:
        """
    ...
    def list_tags_for_resource(self, ResourceName: str) -> Dict:
        ...
        You can have a maximum of 50 cost allocation tags on an ElastiCache resource. For more information, see `Monitoring Costs with Tags <http://docs.aws.amazon.com/AmazonElastiCache/latest/red-ug/Tagging.html>`__ .
    ...
    def modify_cache_cluster(self, CacheClusterId: str, NumCacheNodes: int = None, CacheNodeIdsToRemove: List = None, AZMode: str = None, NewAvailabilityZones: List = None, CacheSecurityGroupNames: List = None, SecurityGroupIds: List = None, PreferredMaintenanceWindow: str = None, NotificationTopicArn: str = None, CacheParameterGroupName: str = None, NotificationTopicStatus: str = None, ApplyImmediately: bool = None, EngineVersion: str = None, AutoMinorVersionUpgrade: bool = None, SnapshotRetentionLimit: int = None, SnapshotWindow: str = None, CacheNodeType: str = None) -> Dict:
        ...
        **Request Syntax** 
        ...
        :param EngineVersion: 
           ...
           **Important:** You can upgrade to a newer engine version (see `Selecting a Cache Engine and Version <http://docs.aws.amazon.com/AmazonElastiCache/latest/red-ug/SelectEngine.html#VersionManagement>`__ ), but you cannot downgrade to an earlier engine version. If you want to use an earlier engine version, you must delete the existing cluster and create it anew with the earlier engine version. 
