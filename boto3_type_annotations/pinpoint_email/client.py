...
class Client(BaseClient):
    ...
    def send_email(self, FromEmailAddress: str = None, Destination: Dict, ReplyToAddresses: List = None, FeedbackForwardingEmailAddress: str = None, Content: Dict, EmailTags: List = None, ConfigurationSetName: str = None) -> Dict:
        """
