...
class Client(BaseClient):
    ...
    def delete_function_concurrency(self, FunctionName: str) -> NoReturn:
        """
        Removes concurrent execution limits from this function. For more information, see `Managing Concurrency <http://docs.aws.amazon.com/lambda/latest/dg/concurrent-executions.html>`__ .
    ...
    def list_versions_by_function(self, FunctionName: str, Marker: str = None, MaxItems: int = None) -> Dict:
        """
        Lists all versions of a function. For information about versioning, see `AWS Lambda Function Versioning and Aliases <http://docs.aws.amazon.com/lambda/latest/dg/versioning-aliases.html>`__ . 
