...
class Client(BaseClient):
    ...
    def associate_s3_resources(self, memberAccountId: str = None, s3Resources: List) -> Dict:
        """
    ...
    def disassociate_s3_resources(self, memberAccountId: str = None, associatedS3Resources: List) -> Dict:
        """
    ...
    def update_s3_resources(self, memberAccountId: str = None, s3ResourcesUpdate: List) -> Dict:
        """
