...
class Client(BaseClient):
    ...
    def post_content(self, botName: str, botAlias: str, userId: str, sessionAttributes: str = None, requestAttributes: str = None, contentType: str, accept: str = None, inputStream: Union[bytes, IO]) -> Dict:
        """
    ...
    def post_text(self, botName: str, botAlias: str, userId: str, sessionAttributes: Dict = None, requestAttributes: Dict = None, inputText: str) -> Dict:
        """
