...
class Client(BaseClient):
    def add_attachments_to_set(self, attachmentSetId: str = None, attachments: List) -> Dict:
        """
    ...
    def add_communication_to_case(self, caseId: str = None, communicationBody: str, ccEmailAddresses: List = None, attachmentSetId: str = None) -> Dict:
        """
    ...
    def create_case(self, subject: str, serviceCode: str = None, severityCode: str = None, categoryCode: str = None, communicationBody: str, ccEmailAddresses: List = None, language: str = None, issueType: str = None, attachmentSetId: str = None) -> Dict:
        """
