...
class Client(BaseClient):
    ...
    def create_custom_action_type(self, category: str, provider: str, version: str, settings: Dict = None, configurationProperties: List = None, inputArtifactDetails: Dict, outputArtifactDetails: Dict) -> Dict:
        """
