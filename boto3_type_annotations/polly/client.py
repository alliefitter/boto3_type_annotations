...
class Client(BaseClient):
                ...
                'Voices': [
                    {
                        ...
                        'AdditionalLanguageCodes': [
                            'cmn-CN'|'cy-GB'|'da-DK'|'de-DE'|'en-AU'|'en-GB'|'en-GB-WLS'|'en-IN'|'en-US'|'es-ES'|'es-US'|'fr-CA'|'fr-FR'|'is-IS'|'it-IT'|'ja-JP'|'hi-IN'|'ko-KR'|'nb-NO'|'nl-NL'|'pl-PL'|'pt-BR'|'pt-PT'|'ro-RO'|'ru-RU'|'sv-SE'|'tr-TR',
                        ]
                    },
                ],
                'NextToken': 'string'
    ...
    def start_speech_synthesis_task(self, LexiconNames: List = None, OutputFormat: str, OutputS3BucketName: str, OutputS3KeyPrefix: str = None, SampleRate: str = None, SnsTopicArn: str = None, SpeechMarkTypes: List = None, Text: str, TextType: str = None, VoiceId: str, LanguageCode: str = None) -> Dict:
        """
    ...
    def synthesize_speech(self, LexiconNames: List = None, OutputFormat: str, SampleRate: str = None, SpeechMarkTypes: List = None, Text: str, TextType: str = None, VoiceId: str, LanguageCode: str = None) -> Dict:
        """
