...
class Client(BaseClient):
    ...
    def start_transcription_job(self, TranscriptionJobName: str, LanguageCode: str, MediaSampleRateHertz: int = None, MediaFormat: str, Media: Dict, OutputBucketName: str = None, Settings: Dict = None) -> Dict:
        """
