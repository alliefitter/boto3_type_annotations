...
class Client(BaseClient):
    ...
    def apply_environment_managed_action(self, EnvironmentName: str = None, EnvironmentId: str = None, ActionId: str) -> Dict:
        """
    ...
    def request_environment_info(self, EnvironmentId: str = None, EnvironmentName: str = None, InfoType: str) -> NoReturn:
        """
    ...
    def retrieve_environment_info(self, EnvironmentId: str = None, EnvironmentName: str = None, InfoType: str) -> Dict:
        """
    ...
    def validate_configuration_settings(self, ApplicationName: str, TemplateName: str = None, EnvironmentName: str = None, OptionSettings: List) -> Dict:
        """
