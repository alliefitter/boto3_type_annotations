...
class Client(BaseClient):
    ...
    def describe_dimension_keys(self, ServiceType: str, Identifier: str, StartTime: datetime, EndTime: datetime, Metric: str, PeriodInSeconds: int = None, GroupBy: Dict, PartitionBy: Dict = None, Filter: Dict = None, MaxResults: int = None, NextToken: str = None) -> Dict:
        """
