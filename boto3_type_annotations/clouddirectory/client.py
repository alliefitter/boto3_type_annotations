...
class Client(BaseClient):
    def add_facet_to_object(self, DirectoryArn: str, SchemaFacet: Dict, ObjectAttributeList: List = None, ObjectReference: Dict) -> Dict:
        """
    ...
    def get_object_attributes(self, DirectoryArn: str, ObjectReference: Dict, ConsistencyLevel: str = None, SchemaFacet: Dict, AttributeNames: List) -> Dict:
        """
        Retrieves attributes within a facet that are associated with an object.
    ...
    def list_index(self, DirectoryArn: str, RangesOnIndexedValues: List = None, IndexReference: Dict, MaxResults: int = None, NextToken: str = None, ConsistencyLevel: str = None) -> Dict:
        """
        Lists objects attached to the specified index.
