...
class Client(BaseClient):
    ...
    def create_compute_environment(self, computeEnvironmentName: str, type: str, state: str = None, computeResources: Dict = None, serviceRole: str) -> Dict:
        """
    ...
    def create_job_queue(self, jobQueueName: str, state: str = None, priority: int, computeEnvironmentOrder: List) -> Dict:
        """
    ...
    def submit_job(self, jobName: str, jobQueue: str, arrayProperties: Dict = None, dependsOn: List = None, jobDefinition: str, parameters: Dict = None, containerOverrides: Dict = None, retryStrategy: Dict = None, timeout: Dict = None) -> Dict:
        """
