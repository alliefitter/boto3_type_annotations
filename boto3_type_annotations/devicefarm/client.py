...
class Client(BaseClient):
    ...
    def create_device_pool(self, projectArn: str, name: str, description: str = None, rules: List) -> Dict:
        """
    ...
    def schedule_run(self, projectArn: str, appArn: str = None, devicePoolArn: str, name: str = None, test: Dict, configuration: Dict = None, executionConfiguration: Dict = None) -> Dict:
        """
        Schedules a run.
