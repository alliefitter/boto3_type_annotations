...
class Client(BaseClient):
    ...
    def create_user(self, Username: str, Password: str = None, IdentityInfo: Dict = None, PhoneConfig: Dict, DirectoryUserId: str = None, SecurityProfileIds: List, RoutingProfileId: str, HierarchyGroupId: str = None, InstanceId: str) -> Dict:
        """
    ...
    def get_current_metric_data(self, InstanceId: str, Filters: Dict, Groupings: List = None, CurrentMetrics: List, NextToken: str = None, MaxResults: int = None) -> Dict:
        """
    ...
    def get_metric_data(self, InstanceId: str, StartTime: datetime, EndTime: datetime, Filters: Dict, Groupings: List = None, HistoricalMetrics: List, NextToken: str = None, MaxResults: int = None) -> Dict:
        """
    ...
    def update_user_hierarchy(self, HierarchyGroupId: str = None, UserId: str, InstanceId: str) -> NoReturn:
        """
