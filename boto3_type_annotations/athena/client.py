...
class Client(BaseClient):
    ...
    def create_named_query(self, Name: str, Description: str = None, Database: str, QueryString: str, ClientRequestToken: str = None) -> Dict:
        """
    ...
    def start_query_execution(self, QueryString: str, ClientRequestToken: str = None, QueryExecutionContext: Dict = None, ResultConfiguration: Dict) -> Dict:
        """
