...
class Client(BaseClient):
    ...
    def describe_scaling_policies(self, PolicyNames: List = None, ServiceNamespace: str, ResourceId: str = None, ScalableDimension: str = None, MaxResults: int = None, NextToken: str = None) -> Dict:
        """
    ...
    def describe_scheduled_actions(self, ScheduledActionNames: List = None, ServiceNamespace: str, ResourceId: str = None, ScalableDimension: str = None, MaxResults: int = None, NextToken: str = None) -> Dict:
        """
    ...
    def put_scheduled_action(self, ServiceNamespace: str, Schedule: str = None, ScheduledActionName: str, ResourceId: str, ScalableDimension: str = None, StartTime: datetime = None, EndTime: datetime = None, ScalableTargetAction: Dict = None) -> Dict:
        """
