...
class Client(BaseClient):
    ...
    def create_hit(self, MaxAssignments: int = None, AutoApprovalDelayInSeconds: int = None, LifetimeInSeconds: int, AssignmentDurationInSeconds: int, Reward: str, Title: str, Keywords: str = None, Description: str, Question: str = None, RequesterAnnotation: str = None, QualificationRequirements: List = None, UniqueRequestToken: str = None, AssignmentReviewPolicy: Dict = None, HITReviewPolicy: Dict = None, HITLayoutId: str = None, HITLayoutParameters: List = None) -> Dict:
        """
    ...
    def create_hit_type(self, AutoApprovalDelayInSeconds: int = None, AssignmentDurationInSeconds: int, Reward: str, Title: str, Keywords: str = None, Description: str, QualificationRequirements: List = None) -> Dict:
        """
    ...
    def create_hit_with_hit_type(self, HITTypeId: str, MaxAssignments: int = None, LifetimeInSeconds: int, Question: str = None, RequesterAnnotation: str = None, UniqueRequestToken: str = None, AssignmentReviewPolicy: Dict = None, HITReviewPolicy: Dict = None, HITLayoutId: str = None, HITLayoutParameters: List = None) -> Dict:
        """
    ...
    def create_qualification_type(self, Name: str, Keywords: str = None, Description: str, QualificationTypeStatus: str, RetryDelayInSeconds: int = None, Test: str = None, AnswerKey: str = None, TestDurationInSeconds: int = None, AutoGranted: bool = None, AutoGrantedValue: int = None) -> Dict:
        """
    ...
    def list_qualification_types(self, Query: str = None, MustBeRequestable: bool, MustBeOwnedByCaller: bool = None, NextToken: str = None, MaxResults: int = None) -> Dict:
        """
