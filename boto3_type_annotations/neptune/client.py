...
class Client(BaseClient):
    ...
    def modify_db_subnet_group(self, DBSubnetGroupName: str, DBSubnetGroupDescription: str = None, SubnetIds: List) -> Dict:
        """
    ...
    def restore_db_cluster_from_snapshot(self, AvailabilityZones: List = None, DBClusterIdentifier: str, SnapshotIdentifier: str, Engine: str, EngineVersion: str = None, Port: int = None, DBSubnetGroupName: str = None, DatabaseName: str = None, OptionGroupName: str = None, VpcSecurityGroupIds: List = None, Tags: List = None, KmsKeyId: str = None, EnableIAMDatabaseAuthentication: bool = None) -> Dict:
        """
