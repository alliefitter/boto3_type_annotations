...
class Metric(base.ServiceResource):
    ...
    def get_statistics(self, Dimensions: List = None, StartTime: datetime, EndTime: datetime, Period: int, Statistics: List = None, ExtendedStatistics: List = None, Unit: str = None) -> Dict:
        """
    ...
    def put_alarm(self, AlarmName: str, AlarmDescription: str = None, ActionsEnabled: bool = None, OKActions: List = None, AlarmActions: List = None, InsufficientDataActions: List = None, Statistic: str = None, ExtendedStatistic: str = None, Dimensions: List = None, Period: int, Unit: str = None, EvaluationPeriods: int, DatapointsToAlarm: int = None, Threshold: float, ComparisonOperator: str, TreatMissingData: str = None, EvaluateLowSampleCountPercentile: str = None) -> 'Alarm':
        """
