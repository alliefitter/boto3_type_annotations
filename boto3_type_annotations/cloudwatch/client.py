...
class Client(BaseClient):
    ...
    def get_metric_statistics(self, Namespace: str, MetricName: str, Dimensions: List = None, StartTime: datetime, EndTime: datetime, Period: int, Statistics: List = None, ExtendedStatistics: List = None, Unit: str = None) -> Dict:
        """
    ...
    def put_metric_alarm(self, AlarmName: str, AlarmDescription: str = None, ActionsEnabled: bool = None, OKActions: List = None, AlarmActions: List = None, InsufficientDataActions: List = None, MetricName: str, Namespace: str, Statistic: str = None, ExtendedStatistic: str = None, Dimensions: List = None, Period: int, Unit: str = None, EvaluationPeriods: int, DatapointsToAlarm: int = None, Threshold: float, ComparisonOperator: str, TreatMissingData: str = None, EvaluateLowSampleCountPercentile: str = None) -> NoReturn:
        """
