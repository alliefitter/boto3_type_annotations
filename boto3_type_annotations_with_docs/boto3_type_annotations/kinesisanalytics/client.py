...
class Client(BaseClient):
    ...
    def add_application_output(self, ApplicationName: str, CurrentApplicationVersionId: int, Output: Dict) -> Dict:
        ...
        You can use one of the output configurations to deliver data from your in-application error stream to an external destination so that you can analyze the errors. For more information, see `Understanding Application Output (Destination) <http://docs.aws.amazon.com/kinesisanalytics/latest/dev/how-it-works-output.html>`__ . 
        Any configuration update, including adding a streaming source using this operation, results in a new version of the application. You can use the  DescribeApplication operation to find the current application version.
    ...
    def create_application(self, ApplicationName: str, ApplicationDescription: str = None, Inputs: List = None, Outputs: List = None, CloudWatchLoggingOptions: List = None, ApplicationCode: str = None) -> Dict:
        """
        Creates an Amazon Kinesis Analytics application. You can configure each application with one streaming source as input, application code to process the input, and up to three destinations where you want Amazon Kinesis Analytics to write the output data from your application. For an overview, see `How it Works <http://docs.aws.amazon.com/kinesisanalytics/latest/dev/how-it-works.html>`__ . 
            ...
            - *(dict) --*
              ...
              - **InputProcessingConfigurationUpdate** *(dict) --*
                ...
                - **InputLambdaProcessorUpdate** *(dict) --* **[REQUIRED]**
                  ...
                  - **ResourceARNUpdate** *(string) --*
                    The Amazon Resource Name (ARN) of the new `AWS Lambda <https://aws.amazon.com/documentation/lambda/>`__ function that is used to preprocess the records in the stream.
                  - **RoleARNUpdate** *(string) --*
