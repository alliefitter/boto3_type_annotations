...
class ListCloudFrontOriginAccessIdentities(Paginator):
    def paginate(self, PaginationConfig: Dict = None) -> Dict:
        ...
        See also: `AWS API Documentation <https://docs.aws.amazon.com/goto/WebAPI/cloudfront-2018-11-05/ListCloudFrontOriginAccessIdentities>`_
...
class ListDistributions(Paginator):
    def paginate(self, PaginationConfig: Dict = None) -> Dict:
        ...
        See also: `AWS API Documentation <https://docs.aws.amazon.com/goto/WebAPI/cloudfront-2018-11-05/ListDistributions>`_
                  ...
                  - **Origins** *(dict) --* 
                    ...
                    - **Items** *(list) --* 
                      ...
                      - *(dict) --* 
                        ...
                        For the current limit on the number of origins or origin groups that you can specify for a distribution, see `Amazon CloudFront Limits <http://docs.aws.amazon.com/general/latest/gr/aws_service_limits.html#limits_cloudfront>`__ in the *AWS General Reference* .
                        - **Id** *(string) --* 
                        ...
                        - **DomainName** *(string) --* 
                          ...
                          For more information about specifying this value for different types of origins, see `Origin Domain Name <http://docs.aws.amazon.com/AmazonCloudFront/latest/DeveloperGuide/distribution-web-values-specify.html#DownloadDistValuesDomainName>`__ in the *Amazon CloudFront Developer Guide* .
...
class ListInvalidations(Paginator):
    def paginate(self, DistributionId: str, PaginationConfig: Dict = None) -> Dict:
        ...
        See also: `AWS API Documentation <https://docs.aws.amazon.com/goto/WebAPI/cloudfront-2018-11-05/ListInvalidations>`_
...
class ListStreamingDistributions(Paginator):
    def paginate(self, PaginationConfig: Dict = None) -> Dict:
        ...
        See also: `AWS API Documentation <https://docs.aws.amazon.com/goto/WebAPI/cloudfront-2018-11-05/ListStreamingDistributions>`_
