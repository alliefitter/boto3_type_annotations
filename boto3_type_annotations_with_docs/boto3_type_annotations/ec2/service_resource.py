...
class ServiceResource(base.ServiceResource):
    ...
    def create_internet_gateway(self, DryRun: bool = None) -> 'InternetGateway':
        ...
        For more information about your VPC and internet gateway, see the `Amazon Virtual Private Cloud User Guide <https://docs.aws.amazon.com/AmazonVPC/latest/UserGuide/>`__ .
    ...
    def create_route_table(self, VpcId: str, DryRun: bool = None) -> 'RouteTable':
        ...
        For more information, see `Route Tables <https://docs.aws.amazon.com/AmazonVPC/latest/UserGuide/VPC_Route_Tables.html>`__ in the *Amazon Virtual Private Cloud User Guide* .
    ...
    def create_subnet(self, CidrBlock: str, VpcId: str, AvailabilityZone: str = None, AvailabilityZoneId: str = None, Ipv6CidrBlock: str = None, DryRun: bool = None) -> 'Subnet':
        ...
        For more information about subnets, see `Your VPC and Subnets <https://docs.aws.amazon.com/AmazonVPC/latest/UserGuide/VPC_Subnets.html>`__ in the *Amazon Virtual Private Cloud User Guide* .
    ...
    def create_vpc_peering_connection(self, DryRun: bool = None, PeerOwnerId: str = None, PeerVpcId: str = None, VpcId: str = None, PeerRegion: str = None) -> 'VpcPeeringConnection':
        ...
        .. note::
          Limitations and rules apply to a VPC peering connection. For more information, see the `limitations <https://docs.aws.amazon.com/AmazonVPC/latest/PeeringGuide/vpc-peering-basics.html#vpc-peering-limitations>`__ section in the *VPC Peering Guide* .
...
class DhcpOptions(base.ServiceResource):
    ...
    def associate_with_vpc(self, VpcId: str, DryRun: bool = None):
        ...
        For more information, see `DHCP Options Sets <https://docs.aws.amazon.com/AmazonVPC/latest/UserGuide/VPC_DHCP_Options.html>`__ in the *Amazon Virtual Private Cloud User Guide* .
...
class Instance(base.ServiceResource):
    ...
    def attach_volume(self, Device: str, VolumeId: str, DryRun: bool = None) -> Dict:
        ...
        Encrypted EBS volumes may only be attached to instances that support Amazon EBS encryption. For more information, see `Amazon EBS Encryption <https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/EBSEncryption.html>`__ in the *Amazon Elastic Compute Cloud User Guide* .
        For a list of supported device names, see `Attaching an EBS Volume to an Instance <https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/ebs-attaching-volume.html>`__ . Any device names that aren't reserved for instance store volumes can be used for EBS volumes. For more information, see `Amazon EC2 Instance Store <https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/InstanceStorage.html>`__ in the *Amazon Elastic Compute Cloud User Guide* .
        If a volume has an AWS Marketplace product code:
        * The volume can be attached only to a stopped instance. 
        * AWS Marketplace product codes are copied from the volume to the instance. 
        * You must be subscribed to the product. 
        * The instance type and operating system of the instance must support the product. For example, you can't detach a volume from a Windows instance and attach it to a Linux instance. 
        For more information about EBS volumes, see `Attaching Amazon EBS Volumes <https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/ebs-attaching-volume.html>`__ in the *Amazon Elastic Compute Cloud User Guide* .
...
class InternetGateway(base.ServiceResource):
    ...
    def attach_to_vpc(self, VpcId: str, DryRun: bool = None):
        """
        Attaches an internet gateway to a VPC, enabling connectivity between the internet and the VPC. For more information about your VPC and internet gateway, see the `Amazon Virtual Private Cloud User Guide <https://docs.aws.amazon.com/AmazonVPC/latest/UserGuide/>`__ .
...
class NetworkAcl(base.ServiceResource):
    ...
    def create_entry(self, Egress: bool, Protocol: str, RuleAction: str, RuleNumber: int, CidrBlock: str = None, DryRun: bool = None, IcmpTypeCode: Dict = None, Ipv6CidrBlock: str = None, PortRange: Dict = None):
        ...
        For more information about network ACLs, see `Network ACLs <https://docs.aws.amazon.com/AmazonVPC/latest/UserGuide/VPC_ACLs.html>`__ in the *Amazon Virtual Private Cloud User Guide* .
    ...
    def replace_association(self, AssociationId: str, DryRun: bool = None) -> Dict:
        """
        Changes which network ACL a subnet is associated with. By default when you create a subnet, it's automatically associated with the default network ACL. For more information, see `Network ACLs <https://docs.aws.amazon.com/AmazonVPC/latest/UserGuide/VPC_ACLs.html>`__ in the *Amazon Virtual Private Cloud User Guide* .
    ...
    def replace_entry(self, Egress: bool, Protocol: str, RuleAction: str, RuleNumber: int, CidrBlock: str = None, DryRun: bool = None, IcmpTypeCode: Dict = None, Ipv6CidrBlock: str = None, PortRange: Dict = None):
        """
        Replaces an entry (rule) in a network ACL. For more information, see `Network ACLs <https://docs.aws.amazon.com/AmazonVPC/latest/UserGuide/VPC_ACLs.html>`__ in the *Amazon Virtual Private Cloud User Guide* .
...
class RouteTable(base.ServiceResource):
    ...
    def create_route(self, DestinationCidrBlock: str = None, DestinationIpv6CidrBlock: str = None, DryRun: bool = None, EgressOnlyInternetGatewayId: str = None, GatewayId: str = None, InstanceId: str = None, NatGatewayId: str = None, TransitGatewayId: str = None, NetworkInterfaceId: str = None, VpcPeeringConnectionId: str = None) -> 'Route':
        ...
        * ``192.0.2.0/28`` (goes to some target B) 
        ...
        For more information about route tables, see `Route Tables <https://docs.aws.amazon.com/AmazonVPC/latest/UserGuide/VPC_Route_Tables.html>`__ in the *Amazon Virtual Private Cloud User Guide* .
